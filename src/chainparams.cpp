...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE; // Always segwit on
...
public:
    CTestNetParams() {
        ...
        checkpointData = {
            {
                {0, uint256S("211cfe5f0a0bbec995dc6820a149bce0618a3b34b011c6b1d43d2c3f9fbda502")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        checkpointData = {
            {
                {0, uint256S("c367fb00112deecb71ac1459e845b34bdee172c9fd5c4fc7aaf6a4546cdb522b")},
            }
        };
